...
z2 = a1 * Theta1';
a2 = sigmoid(z2);
a2 = [ones(size(a2,1),1), a2]; % adding 1 as first column in z
...
%Backpropagation (Vectorized Implementation)
...
%Calculating theta gradient with regularization

%adding regularization term in J and theta_grad
